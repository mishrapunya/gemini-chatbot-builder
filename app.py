...
with st.sidebar:
    ...
    <div style="text-align: center; color: #718096; font-size: 0.8rem;">
        ...
        <span style="font-size: 0.7rem;">This work is licensed under<br><a href="https://creativecommons.org/licenses/by-nc-sa/4.0/" target="_blank" style="color: #2563EB; text-decoration: none;">Creative Commons Attribution-NonCommercial-ShareAlike 4.0</a></span>
    </div>
    """, unsafe_allow_html=True)
