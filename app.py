...
elif st.session_state.current_view == "Prompt Guide":
...
with st.expander("Current Configuration"):
    ...
    st.write(f"**Temperature:** {st.session_state.temperature}") = "You are a helpful assistant named Gemini Assistant. You're friendly, concise, and informative. When answering questions, provide accurate information and be honest when you don't know something."
...
# Add current view to session state
...
with st.sidebar:
    ...
    with col1:
        if st.button("Bot Builder"):
            st.session_state.current_view = "Bot Builder"
    with col2:
        if st.button("Prompt Guide"):
            st.session_state.current_view = "Prompt Guide"
